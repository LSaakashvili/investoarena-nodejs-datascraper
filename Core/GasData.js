...
const GasData = async(req, res) => {
    ...
    return res.json([{
        ...
        ch:$naturalgas('.push-data')[21].children[0].data.trim(),
        ...
        ch:$naturalgas('.push-data')[25].children[0].data.trim(),
        ...
        ch:$naturalgas('.push-data')[29].children[0].data.trim(),
        ...
        ch:$naturalgas('.push-data')[33].children[0].data.trim(),
        chp:0,
        data:$naturalgas('.push-data')[35].children[0].data,
    }, {
        name:"RBOB Gasoline",
        price:$naturalgas('.push-data')[36].children[0].data,
        ch:$naturalgas('.push-data')[37].children[0].data.trim(),
        ...
        ch:$naturalgas('.push-data')[45].children[0].data.trim(),
        ...
        ch:$naturalgas('.push-data')[49].children[0].data.trim(),
