...
const MetalsData = async(req, res) => {
    ...
    ch:$naturalgas('.push-data')[1].children[0].data.trim(),
    ...
    ch:$naturalgas('.push-data')[5].children[0].data.trim(),
    ...
    ch:$naturalgas('.push-data')[9].children[0].data.trim(),
    ...
    ch:$naturalgas('.push-data')[13].children[0].data.trim(),
    ...
    ch:$naturalgas('.push-data')[17].children[0].data.trim(),
    ...
    ch:$naturalgas('.push-data')[53].children[0].data.trim(),
    ...
    ch:$naturalgas('.push-data')[57].children[0].data.trim(),
    ...
    ch:$naturalgas('.push-data')[61].children[0].data.trim(),
    ...
    ch:$naturalgas('.push-data')[65].children[0].data.trim(),
    ...
    ch:$naturalgas('.push-data')[69].children[0].data.trim(),
    ...
    ch:$naturalgas('.push-data')[73].children[0].data.trim(),
    ...
    ch:$naturalgas('.push-data')[77].children[0].data.trim(),
